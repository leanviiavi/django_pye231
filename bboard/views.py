...
class BbCreateView(CreateView):
    ...
    def form_valid(self, form):
        """ Этот метод вызывается при успешной валидации формы """
        # Добавляем логику для установки значения "Одобрено модератором"
        form.instance.approved_by_moderator = False  # По умолчанию не одобрено
